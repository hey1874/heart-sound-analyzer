...
| **S2 分裂** | A2–P2 间期(Hilbert 双峰),宽固定分裂提示 ASD |
| **频域 HRV** | LF/HF 自主神经平衡(需 ≥1–2 分钟记录,带门控) |
...
[9] S3检测: 正常 s3=0.007  含S3 s3=0.386 -> 「疑似S3...」  ✅
[10] S2分裂: 注入50ms -> 估计 50ms (占比93%)  ✅
[11] 频域HRV: 短窗可用=False  长记录可用=True LF/HF=0.62  ✅
```
